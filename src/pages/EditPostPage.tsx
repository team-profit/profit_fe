  ...
  return (
    <Flex paddingTop="20px" isColumn gap={32} width="100%">
      ...
      <Flex width="100%" isColumn gap={24}>
        ...
        <Flex gap={8} alignItems="end" width="100%">
          <Inputs
            ...
            label="상차 시간"
          />
          <Button onClick={() => handleDateButtonClick('start')}>
            시간 수정
          </Button>
        </Flex>
        <Flex gap={8} alignItems="end" width="100%">
          <Inputs
            ...
            label="하차 시간"
          />
          <Button onClick={() => handleDateButtonClick('end')}>
            시간 수정
          </Button>
        </Flex>
      </Flex>
      ...
      {showPostcode.show && (
        ...
        >
          <PostcodeWrapper onClick={(e) => e.stopPropagation()}>
            <CloseButton
              onClick={() => setShowPostcode({ show: false, type: null })}
            >
              ✕
      ...
      {showDatePicker.show && (
        <PostcodeModal
          onClick={() => setShowDatePicker({ show: false, type: null })}
        >
